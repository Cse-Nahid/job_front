...
const handleRegister = async (event) => {
  ...
  try {
    ...
    const res = await fetch("https://jobhunt-backend-r224.onrender.com/candidate/register/", {
      method: "POST",
      headers: {
...
const handleLogin = async (event) => {
  ...
  try {
    const res = await fetch("https://jobhunt-backend-r224.onrender.com/candidate/login/", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
